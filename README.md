This is a program that opens a fullscreen window that changes to a random color at a random interval*, when the mouse is clicked, when the mouse is scrolled, and when a key is pressed. 
